...
kpi_cards = [
	html.Div([
		...
		"background": "#23233e", "padding": "1rem 6rem", "borderRadius": "18px", "margin": "0 0.7rem", "color": "white"
	})
	for _, row in df_kpi.iterrows()
]

# Monatliche Einnahmen
fig_earnings = px.line(df_monthly, x="Month", y=["Current_Income", "Last_Month_Income"],
					   labels={"value": "Income", "variable": "Legend"},
					   color_discrete_map={
						   "Current_Income": "blue",
						   "Last_Month_Income": "red"
					   },
...
fig_status.update_traces(textinfo="label+percent", marker=dict(line=dict(color='#181b2a', width=2)))
...
app.layout = html.Div(
	...
	style={"background": "#181b2a", "padding": "2rem","margin": "-0.5rem", "minHeight": "100vh", "box-sizing":"border-box"}
)
